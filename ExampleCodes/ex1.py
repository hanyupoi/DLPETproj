...
# Inspect the domain and range of the RayTransform
print(f"Domain: {ray_trafo.domain}")
print(f"Range: {ray_trafo.range}")

# Explore available methods and attributes
#print(dir(ray_trafo))
